...
public class DependencyGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/easy_code?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&nullCatalogMeansCurrent=true");
        ...
        pc.setParent("com.day");
        pc.setMapper("mapper");
        pc.setService("com.day.service");
        pc.setServiceImpl("com.day.service.impl");
        pc.setController("com.day.controller");
        pc.setEntity("pojo");
...
//        strategy.setSuperControllerClass("你自己的父类控制器,没有就不用设置!");
        ...
        tableFillList.add(new TableFill("department_id", FieldFill.INSERT));
